    ...
    <div className="space-y-8 animate-fadeIn">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        <section className="parchment p-6 rounded-md">
          <h3 className="medieval-font text-2xl mb-4 border-b-2 border-[#8b6b40] pb-2">
            Status da Sessão
          </h3>
        ...
        <section className="parchment p-6 rounded-md">
          ...
          <div className="grid grid-cols-2 gap-4">
            <QuickActionButton
              label="Narrar Encontro"
              color="dark-red-bg"
              onClick={() => setActive('narrator')}
            />

            <QuickActionButton
              label="Consultar Combate"
              color="bg-[#3d2b1f]"
          ...
          <div className="mt-6 p-4 bg-black/10 rounded border border-dashed border-[#8b6b40]">
            <p className="text-sm font-bold text-[#5a0a0a]">
              DICA DO MESTRE:
            </p>

            <p className="text-xs opacity-70">
              Em Mighty Blade, um sucesso crítico em ataque causa o dobro do dano
              total. Some bônus antes de multiplicar.
            </p>
          </div>
        </section>
      </div>
